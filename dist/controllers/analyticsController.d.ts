...
export declare const getGeographyAnalytics: (_req: AuthRequest, res: Response) => Promise<Response<any, Record<string, any>>>;
export declare const getCityAnalytics: (req: AuthRequest, res: Response) => Promise<Response<any, Record<string, any>>>;
export declare const getSubjectAnalytics: (_req: AuthRequest, res: Response) => Promise<Response<any, Record<string, any>>>;
export declare const getSupplyDemandAnalytics: (req: AuthRequest, res: Response) => Promise<Response<any, Record<string, any>>>;
