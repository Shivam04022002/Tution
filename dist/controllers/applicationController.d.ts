...
export declare const getRequirementApplications: (req: AuthRequest, res: Response) => Promise<Response<any, Record<string, any>>>;
export declare const viewApplication: (req: AuthRequest, res: Response) => Promise<Response<any, Record<string, any>>>;
export declare const selectTeacher: (req: AuthRequest, res: Response) => Promise<Response<any, Record<string, any>>>;
export declare const hireTeacher: (req: AuthRequest, res: Response) => Promise<Response<any, Record<string, any>>>;
